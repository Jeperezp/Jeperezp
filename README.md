...
- 🔄 Experiencia como Scrum Master en equipos ágiles, facilitando la entrega continua de valor.
- 📊 Apoyo en la implementación de prácticas ágiles como Scrum, Kanban y Lean para mejorar la eficiencia y la calidad del producto.
- 💪 Liderazgo en la adopción de metodologías ágiles en equipos multidisciplinarios, fomentando la colaboración y el aprendizaje continuo.

## Habilidades Destacadas

### 🚀 Proyectos
- Liderazgo y gestión de proyectos bajo la metodología Scrum, garantizando la entrega de productos de alta calidad en tiempos y presupuestos definidos.
- Apoyo en la definición de objetivos, alcance y planificación de proyectos, utilizando herramientas como Jira y Trello.
...
- Liderazgo en la implementación de metodologías ágiles en un equipo de desarrollo de software, logrando aumentar la productividad en un 30%.
- Automatización de procesos de reporte utilizando Power Automate, reduciendo el tiempo de trabajo en un 50%.
- Automatizacion de tareas y reporteria mediante python.
...
- 💼 LinkedIn: www.linkedin.com/in/jeisson-perez-7314ab66
